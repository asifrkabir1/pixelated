                    ...
                    <?php $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div>
                                            <a href="<?php echo e(route('admin.edit', $portfolio->id)); ?>"
                                                class="btn btn-primary m-2">Edit</a>
                                        </div>
                                        <div>
                                            <form action="<?php echo e(route('admin.destroy', $portfolio->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Courses\Laravel\LaravelProject\pixelated\resources\views/pages/admin/list.blade.php ENDPATH**/ ?>