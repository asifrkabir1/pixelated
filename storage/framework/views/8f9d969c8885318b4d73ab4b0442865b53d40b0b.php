    ...
    <?php $__env->startSection('content'); ?>
        ...
        <main style="">
            <div class="container-fluid px-4">
                ...
                <form action="<?php echo e(route('user.portfolios.update', $portfolio->id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php endif; ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Courses\Laravel\LaravelProject\pixelated\resources\views/pages/portfolios/edit.blade.php ENDPATH**/ ?>