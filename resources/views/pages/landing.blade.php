...
<html lang="en">
    ...
    <body>
        <!-- Background Video-->
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="{{ asset('assets/mp4/bg2.mp4') }}" type="video/mp4" /></video>
        <!-- Masthead-->
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('login') }}"><button class="btn btn-primary me-3" id="submitButton" type="submit">Login</button></a>
                        <a href="{{ route('register') }}"><button class="btn btn-primary" id="submitButton" type="submit">Sign Up</button></a>
                    </div>
                </div>
            </div>
        </div>
